...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/24 15:27:17 by franaivo          #+#    #+#             */
/*   Updated: 2024/07/24 15:52:32 by franaivo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const char	*get_player_run_right(void)
{
	...
	player_run_right = "./asset/xmp/player/run_right1.xpm,"
...
{
	const char	*player_run_left;

	player_run_left = "./asset/xmp/player/run_left1.xpm,"
...
{
	const char	*player_run_top;

	player_run_top = "./asset/xmp/player/run_top1.xpm,"
	...
	return (player_run_top);
}

const char	*get_player_run_bottom(void)
{
	const char	*player_run_bottom;

	player_run_bottom = "./asset/xmp/player/run_bottom1.xpm,"
